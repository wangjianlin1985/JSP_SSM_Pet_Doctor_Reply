...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=doctor.getDoctorNo()%></div>
	</div>
	 
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">姓名:</div>
		<div class="col-md-10 col-xs-6"><%=doctor.getName()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">性别:</div>
		<div class="col-md-10 col-xs-6"><%=doctor.getGender()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=doctor.getZc()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">联系电话:</div>
		<div class="col-md-10 col-xs-6"><%=doctor.getTelephone()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">工作经验:</div>
		<div class="col-md-10 col-xs-6"><%=doctor.getWorkYear()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">入职时间:</div>
		<div class="col-md-10 col-xs-6"><%=doctor.getRegTime()%></div>
	</div>
	<div class="row bottom15">
