...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">宠物答疑网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>QuestionClass/frontlist">问题分类</a></li>
                <li><a href="<%=basePath %>Question/frontlist">问题列表</a></li>
                <!-- 
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Question/question_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布问题</a></li>
                        <li><a href="<%=basePath %>Question/frontUserlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的问题</a></li>
