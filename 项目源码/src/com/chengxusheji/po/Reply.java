...
public class Reply {
    ...
    /*被回帖子*/
    private Question postInfoObj;
    public Question getPostInfoObj() {
        return postInfoObj;
    }
    public void setPostInfoObj(Question postInfoObj) {
    ...
    /*回复医生*/
    private Doctor userObj;
    public Doctor getUserObj() {
        return userObj;
    }
    public void setUserObj(Doctor userObj) {
    ...
    public JSONObject getJsonObject() throws JSONException {
		...
		jsonReply.accumulate("userObjPri", this.getUserObj().getDoctorNo());
