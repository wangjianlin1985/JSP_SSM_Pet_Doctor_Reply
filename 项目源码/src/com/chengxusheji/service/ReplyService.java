...
public class ReplyService {
    ...
    /*按照查询条件分页查询帖子回复记录*/
    public ArrayList<Reply> queryReply(Question postInfoObj,Doctor userObj,String replyTime,int currentPage) throws Exception { 
    	...
    	if(null != userObj &&  userObj.getDoctorNo() != null  && !userObj.getDoctorNo().equals(""))  where += " and t_reply.userObj='" + userObj.getDoctorNo() + "'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Reply> queryReply(Question postInfoObj,Doctor userObj,String replyTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != postInfoObj && postInfoObj.getPostInfoId()!= null && postInfoObj.getPostInfoId()!= 0)  where += " and t_reply.postInfoObj=" + postInfoObj.getPostInfoId();
    	if(null != userObj &&  userObj.getDoctorNo() != null && !userObj.getDoctorNo().equals(""))  where += " and t_reply.userObj='" + userObj.getDoctorNo() + "'";
    	if(!replyTime.equals("")) where = where + " and t_reply.replyTime like '%" + replyTime + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Question postInfoObj,Doctor userObj,String replyTime) throws Exception {
     	String where = "where 1=1";
    	if(null != postInfoObj && postInfoObj.getPostInfoId()!= null && postInfoObj.getPostInfoId()!= 0)  where += " and t_reply.postInfoObj=" + postInfoObj.getPostInfoId();
    	if(null != userObj &&  userObj.getDoctorNo() != null && !userObj.getDoctorNo().equals(""))  where += " and t_reply.userObj='" + userObj.getDoctorNo() + "'";
    	if(!replyTime.equals("")) where = where + " and t_reply.replyTime like '%" + replyTime + "%'";
